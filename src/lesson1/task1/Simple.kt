 ...
 */
fun angleInRadian(grad: Int, min: Int, sec: Int): Double = PI * (3600 * grad + 60 * min + sec) / 180 / 3600
/**
 * Тривиальная
 *
...
fun thirdDigit(number: Int): Int = floorDiv(floorDiv(number, 10), 10)%10
 ...
 */
fun accountInThreeYears(initial: Int, percent: Int): Double = initial*(pow(((percent.toDouble()/100)+1.0),3.0))
 ...
 */
fun numberRevert(number: Int): Int = floorDiv(number,100)+ floorDiv(number,10)%10*10+ number%10*100
